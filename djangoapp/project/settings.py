...
INSTALLED_APPS = [
    ...
    # Axes app can be in any position in the INSTALLED_APPS list.More actions
    'axes',
]
...
MIDDLEWARE = [
    ...
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
     ...
     # AxesMiddleware should be the last middleware in the MIDDLEWARE list.More actions
